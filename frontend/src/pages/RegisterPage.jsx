      ...
      <div className="w-full max-w-md animate-fade-in">
        ...
        <div className="glass-card p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-slate-400 mt-2">Comienza a controlar tus finanzas hoy mismo</p>
          </div>
          ...
          <form className="space-y-4" onSubmit={onSubmit}>
            ...
            <div>
              ...
              <input 
                ...
                disabled={loading}
              />
              <p className="text-xs text-slate-500 mt-1.5 ml-1">Usa una combinación de letras, números y símbolos</p>
            </div>
